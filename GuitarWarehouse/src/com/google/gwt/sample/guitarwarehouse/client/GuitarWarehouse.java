...
import com.google.gwt.sample.guitarwarehouse.shared.FieldVerifier;
	...
	public void onModuleLoad() {
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				if (!nameField.getText().equals(user.getLogin()) || !passwordField.getText().equals(user.getPassword()) ) {
